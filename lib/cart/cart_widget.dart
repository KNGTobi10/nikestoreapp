                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  20.0, 0.0, 0.0, 0.0),
                              child: Text(
                                '${FFAppState().cartItems.toString()} Items',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Poppins',
                              ...
                              return ListView.separated(
                                ...
                                itemBuilder: (context, cartItemIndex) {
                                  ...
                                  return StreamBuilder<ShoesRecord>(
                                    stream:
                                        ShoesRecord.getDocument(cartItemItem),
                                    builder: (context, snapshot) {
                                      ...
                                      final rowShoesRecord = snapshot.data!;
                                      return Row(
                                        mainAxisSize: MainAxisSize.max,
                                        children: [
                                          Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              final paymentResponse =
                                ...
                                context,
                                amount: functions
                                    .stripeamount(FFAppState().cartsum)
                                    .round(),
                                currency: 'USD',
