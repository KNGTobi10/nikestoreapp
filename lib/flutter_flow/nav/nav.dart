      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => FavoriteWidget(
            favoriteref: params.getParam('favoriteref',
                ParamType.DocumentReference, false, ['favorite']),
          ),
        ),
        FFRoute(
          name: 'details',
          ...
          builder: (context, params) => DetailsWidget(
            shoeref: params.getParam(
                'shoeref', ParamType.DocumentReference, false, ['shoes']),
          ),
        ),
        FFRoute(
          name: 'cart',
